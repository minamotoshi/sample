...
function ShapeLoading(){
	...
	showDraw : function(){
		...
		Draw.__browse.on("click", function(e){Draw.browse(); Draw.showDrawing();}, null, true);
		Draw.__stage.update();
	},
	/**
	 *	画图界面运行中
	...
	shirtAct: {
		 ...
		 */
		on: function(){
			touch.on('#drawCanvas', 'touchstart', Draw.shirtAct.touchstart);//按下
			touch.on('#drawCanvas', 'touchend', Draw.shirtAct.touchend);//松开
			touch.on('#drawCanvas', 'drag', Draw.shirtAct.drag);//拖动
			touch.on('#drawCanvas', 'dragend', Draw.shirtAct.dragend);//拖动结束
		 ...
		 */
		off: function(){
			touch.off('#drawCanvas', 'touchstart', Draw.shirtAct.touchstart);
			touch.off('#drawCanvas', 'touchend', Draw.shirtAct.touchend);
			touch.off('#drawCanvas', 'drag', Draw.shirtAct.drag);
			touch.off('#drawCanvas', 'dragend', Draw.shirtAct.dragend);
		},
		/**
		 *	移动准备
		 */
		 ...
		 */
		drag: function(ev){
			Draw.__shirt.x = Draw.shirtAct._pos.x + ev.x;
			Draw.shirtAct.__left.x = Draw.__shirt.x - Draw.shirtAct._pos.width;
			Draw.shirtAct.__right.x = Draw.__shirt.x + Draw.shirtAct._pos.width;
			Draw.shirtAct.moving();
			Draw.__stage.update();
